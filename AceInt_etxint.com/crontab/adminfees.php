...
$transDetails = "Marketing and Promotions Fee";
...
$dbgetmemwithfees = dbRead("select members.memid, members.datejoined, members.CID, members.fiftyclub, members.paymenttype, members.licensee, members.admin_exempt, country.admin_fee, members.fee_deductions, country.reserveacc, country.adminacc, country.DefaultArea from members, country, status where (members.CID = country.countryID) and (members.status = status.FieldID) and (members.admin_exempt = 2 or members.admin_exempt = 0) and status.mem_admin_fee = 1 and country.a_fee = 'Y' and country.admin_fee > 0 and (wagesacc = 0 or wagesacc is null) and members.datejoined < '$pre_month'");
