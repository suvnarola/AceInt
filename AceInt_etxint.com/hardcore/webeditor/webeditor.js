...
//prompt("Browser identification:", navigator_vendor + " -- " + navigator_vendorSub + " -- " + navigator_userAgent + " -- " + navigator_appVersion + " -- " + webbrowser + " -- " + webeditorType + " -- " + majorVersion + " -- " + minorVersion);
...
} else if (webeditorType == "dhtml") {
	document.write('<script src="' + webeditor.rootpath + 'webeditor.properties.js"></script>');
	document.write('<script src="' + webeditor.rootpath + 'webeditor_dhtml_msie.js"></script>');
} else {
	document.write('<script src="' + webeditor.rootpath + 'webeditor.properties.js"></script>');
	document.write('<script src="' + webeditor.rootpath + 'webeditor_textarea.js"></script>');
}
