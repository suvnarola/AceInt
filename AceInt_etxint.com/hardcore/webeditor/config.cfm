...
// Which shell command and parameters to use
shellCommand = "";
shellParameters = "";
// Microsoft Windows must use "cmd.exe /c" to run the spellcheck command
...
root_path = "";
root_path = Left(CGI.PATH_TRANSLATED,Len(CGI.PATH_TRANSLATED)-Len(CGI.PATH_INFO));
...
//enable_upload = "yes";
upload_path = "";
upload_path = Left(CGI.PATH_TRANSLATED,Len(CGI.PATH_TRANSLATED)-Len(CGI.PATH_INFO)) & "/hardcore/upload/";
