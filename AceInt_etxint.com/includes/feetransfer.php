...
<form method="POST" action="body.php?page=feetransfer" name="SFee">
...
<table width="100%" cellspacing="0" cellpadding="3">
  <tr>
    ...
    <td align="right" width="120" class="Heading2"><font size="1" face="Verdana"><b>Move to Acc No:</b></font></td>
  </tr>

	  <tr>
		<input type="hidden" name="memberacc[]" value="<?= $row[memid] ?>">
	    <td width="80" bgcolor="#DDDDDD"><font size="1" face="Verdana"><?= $row[memid] ?></font>&nbsp;</td>
	    <td width="200" bgcolor="#DDDDDD"><font size="1" face="Verdana"><?= $row[companyname] ?></font>&nbsp;</td>
	    <td width="120" bgcolor="#DDDDDD"><input size="32" type="text" name="det[]"></td>
		<td align="right" width="120" bgcolor="#DDDDDD"><font size="1" face="Verdana"><input size="14" type="text" name="to_memid[]" onKeyPress="return number(event)"></font></td>
	  </tr>
