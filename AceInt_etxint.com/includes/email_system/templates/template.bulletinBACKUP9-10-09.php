...
?>
<div class="clickhere"> <?= $countryDataRow['em_top'] ?> <a href="http://media.ebanctrade.com/bulletin.php?jobID=<?= $jobRow['FieldID'] ?>"class="style1">
...
src="http://www.ebanctrade.com/email/images/<?= $logo ?>2.jpg" width="143" height="40"
border="0"></a></td>
  </tr>
  <tr>
