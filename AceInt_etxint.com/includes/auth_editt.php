...
?>
		...
		<tr bgcolor="<?= $bgcolor ?>">
			...
			<td><input size="5" type="text" name="memid[]" value="<?= $row['memid'] ?>" size="20" <?if($row['dollarfees'] > 0) {?>disabled<?}?> style="font-family: Verdana; font-size: 8pt"></td>
			<td><input size="5" type="text" name="to_memid[]" value="<?= $row['to_memid'] ?>" size="20" style="font-family: Verdana; font-size: 8pt"></td>
			<td><input size="8" type="text" name="buy[]" value="<?= $row['buy'] ?>" size="20" style="font-family: Verdana; font-size: 8pt"></td>
			<td><input size="8" type="text" name="sell[]" value="<?= $row['sell'] ?>" size="20" style="font-family: Verdana; font-size: 8pt"></td>
			<td><input size="8" type="text" name="dollarfees[]" value="<?= $row['dollarfees'] ?>" size="20" disabled style="font-family: Verdana; font-size: 8pt"></td>
			<td><select name="cleared[]" style="font-family: Verdana; font-size: 8pt">
			 <option value="0" <? if($row['checked'] == 0) { echo " selected"; } ?>>Yes</option>
			 <option value="1" <? if($row['checked'] == 1) { echo " selected"; } ?>>No</option>
			</select></td>
