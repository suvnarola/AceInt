...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		<td colspan="7" align="center" class="Heading">My Services Banc - Credit Card Report</td>
	</tr>
	<tr>
...
<form name="ccreport" method="POST" action="body.php?page=services_ccreport">
...
<table width="400" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr>
    <td colspan="2" class="Heading2" align="center"><b>My Services Banc - Credit Card Report</b></td>
  </tr>
  <tr>
