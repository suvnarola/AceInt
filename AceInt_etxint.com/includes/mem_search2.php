...
?>
		<tr id="<?= $row['memid'] ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');">
			...
			<img src="images/icon_n<? if($notesarray[$row['memid']] == 1) { echo "2"; } ?>.gif" border="0" width="16" height="15" ?>.gif" border="0" width="16" height="15" ?>.gif" border="0" width="16" height="15"></a></td>
			...
			<a href="body.php?page=member_edit&Client=<?= $row['memid'] ?>&pageno=1&tab=tab7&currentmonth=<?= date("n") ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1" ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1" ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1"><img src="images/icon_s.gif" border="0" width="16" height="15"></a></td>
