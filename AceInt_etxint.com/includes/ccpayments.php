...
function display_receipt($success,$errormsg = false) {
 ...
 if($errormsg) {
  ...
  <tr>
  <td bgcolor="#FFFFFF"><b><?= $errormsg ?></b><br><?= get_word("131") ?>: <?= get_all_added_characters($SecureResponse['response_code']) ?></td>
  </tr>
  </table>
  <br>
  <?
  ...
  <tr>
  <td bgcolor="#FFFFFF"><b><?= get_word("132") ?></b><br><?= get_word("131") ?>: <?= get_all_added_characters($SecureResponse['response_code']) ?></td>
  </tr>
  </table>
  <br>
  <?
  ...
  <td class="Border">
   <table border="0" width="495" cellspacing="0" cellpadding="3">
    ...
    <tr>
     ...
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($SecureResponse['ponum']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("135") ?>:</b></td>
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($SecureResponse['optional_info']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("136") ?>:</b></td>
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($SecureResponse['txn_id']) ?></td>
    </tr>
    <tr>
...
function first_form ($errormsg) {
 ...
 for ($i = 0; ; $i++) {
  if ($i > 11) break;
  $y = mktime(0, 0, 0, date("m"),   date("d"),   date("Y")+$i);
  $exdates[date("y", $y)] = date("Y", $y);
 }
   ...
   <table border="0" width="495" cellspacing="0" cellpadding="3">
    ...
    <tr>
     ...
     <option value="12">12</option>
      ...
      <select size="1" name="exdate2">
       <?
        foreach ($exdates as $k => $v) {
 ...
 <tr>
  <td class="Border">
   <table border="0" width="495" cellspacing="0" cellpadding="3">
    ...
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("133") ?>:</b></td>
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($_REQUEST['ponum']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("134") ?>:</b></td>
     <td width="325" bgcolor="#FFFFFF"><?= get_all_added_characters($_REQUEST['creditCard1']) ?> <?= get_all_added_characters($_REQUEST['creditCard2']) ?> <?= get_all_added_characters($_REQUEST['creditCard3']) ?> <?= get_all_added_characters($_REQUEST['creditCard4']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("64") ?>:</b></td>
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($_REQUEST['exdate1']) ?> <?= get_all_added_characters($_REQUEST['exdate2']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("135") ?>:</b></td>
     <td bgcolor="FFFFFF" width="325"><?= get_all_added_characters($_REQUEST['optional_info']) ?></td>
    </tr>
    <tr>
     <td align="right" valign="middle" class="Heading2" width="170"><b><?= get_word("58") ?>:</b></td>
