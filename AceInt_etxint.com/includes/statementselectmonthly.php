...
if($_REQUEST[send] && $rrr)  {
 ...
 $display_date=date("F, Y", mktime(1,1,1,date("n")-1,1,date("Y")));
    ...
    // send the message.
    $mail->send($_SESSION['User']['Name'], $_SESSION['User']['EmailAddress'], 'E Banc Accounts', 'dave@ebanctrade.com', 'Statement - '.$row2[companyname],'Bcc: dave@ebanctrade.com');
...
<form method="post" action="../includes/statement.php">
...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
	<tr>
		<td colspan="2" align="center" class="Heading2">Statements</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="450" bgcolor="#FFFFFF">
        <input type="submit" value="Get Statements" name="view" style="size: 8pt">
