...
?>
		...
		<?//if($_REQUEST['catid']) {?>
		 <?if($_SESSION['User']['emcus'] == 1 || !checkmodule("EditMemberLevel2")) { ?>
...
<div class="save">
<div><a href="javascript:void(0)" class="dsphead" onclick="dsp(this)"><span class="dspchar">+</span><b> Click to View Cats </b></a></div>
   <div class="dspcont">
      <div class="dsphead2">
<?
$query = dbRead("SELECT * FROM tbl_cat_main order by tbl_cat_main.C_Name");
while($row = mysql_fetch_assoc($query)) {
 ...
 <tr valign="top" bgcolor="#EEEEEE">
  ...
  for($i = 1;$i < $Category_Count+1;$i++) {
   ...
   if(!$Plus) {
    ...
    echo '<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="catnav" href="body.php?PageID=79&categoryid='.$data_structure_id[$INum].'">'.$data_structure[$INum].'&nbsp;<font color="#333333">('.number_format($cat_count[$data_structure[$INum]]).')</font></a><br></font></td>';
    ...
    echo '<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="catnav" href="body.php?PageID=79&categoryid='.$data_structure_id[$NewI].'">'.$data_structure[$NewI].'&nbsp;<font color="#333333">('.number_format($cat_count[$data_structure[$NewI]]).')</font></a><br></font></td>';
