...
TIPSTER v3.1beta (c) 2001-2004 Angus Turnbull, http://www.twinhelix.com
...
LyrFn('alpha','var f=ref.filters,d=(p==null),o=d?"":p/100; if (f) {' +
 'if (!d&&sty.filter.indexOf("alpha")==-1) sty.filter+=" alpha(opacity="+p+")"; ' +
 'else if (f.length&&f.alpha) with(f.alpha){if(d)enabled=false;else{opacity=p;enabled=true}} }' +
 'else if (isDOM){sty.opacity=sty.MozOpacity=o;'+
  'if(sty.setProperty)sty.setProperty("-khtml-opacity",o,"")}');
