...
<form method="POST" action="body.php?page=services_report&ID=<?= $_GET[ID] ?>&tab=<?= $_GET[tab] ?>" name="frmletters">
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		<td colspan="8" align="center" class="Heading">My Services Banc - <?= $gg ?></td>
	</tr>
	<tr>
