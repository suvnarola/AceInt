...
function taxinvoice($query, $stationery = false, $individual = false, $send = false, $rollover = false) {
...
account : 301517791
			...
			$textLeft = 126 ;
		  	...
		  	pdf_rect($pdf, 120, 215, 137, 47);
			pdf_closepath_stroke($pdf);

			pdf_setfont($pdf, $font, 9);
			pdf_set_text_pos($pdf, $textLeft, 257);
			pdf_continue_text($pdf, "Empire Trade Exchange P/L");  //Trade Exchange Pty Ltd

			pdf_setfont($pdf, $fontbold, 9);
			pdf_set_text_pos($pdf, $textLeft, 243);
			pdf_continue_text($pdf, "ANZ BSB:");
			...
			pdf_setfont($pdf, $font, 9);
			pdf_set_text_pos($pdf, $textLeft + 55, 243);
			pdf_continue_text($pdf, "016 454");

			pdf_setfont($pdf, $font, 9);
			pdf_set_text_pos($pdf, $textLeft + 55, 230);
			pdf_continue_text($pdf, "301517791");
