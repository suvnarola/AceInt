  ...
  if($_SESSION['Directory']['top'] || $_SESSION['Directory']['topright']) {
   ...
   if($_SESSION['Directory']['category'] && $_SESSION['Directory']['area']) {
    ...
    if($_SESSION['Directory']['nat']) {
     ...
     $nats = " or mem_categories.dir_nation = 1 or (mem_categories.dir_state = 1 and tbl_area_states.FieldID IN (".$STID."))";
    }
    ...
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_physical.AreaName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state, mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,categories,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE (((members.memid = mem_categories.memid) AND (members.status = status.FieldID) AND (((((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)) AND ((status.mem_dir = 1))$mem) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)) AND (tbl_area_physical.FieldID IN (".$AreaComma.")$nats))) AND (mem_categories.category != 0) AND (mem_categories.category = categories.catid)) $OrderBy");
    ...
    if($_SESSION['Directory']['nat']) {
     ...
     $nats = " or mem_categories.dir_nation = 1 or (mem_categories.dir_state = 1 and tbl_area_states.FieldID = ".$rowstate['FieldID'].")";
    }
    ...
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state,mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE ((((((mem_categories.category = categories.catid) AND (members.status = status.FieldID) AND (categories.catid IN ($CatComma))) AND (members.memid = mem_categories.memid)) AND (((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)$mem) AND ((status.mem_dir = 1)))) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)) AND (tbl_area_regional.FieldID = '".$_SESSION['Directory']['disarea']."' $nats)) $OrderBy");
    ...
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state,mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,categories,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE (((members.memid = mem_categories.memid) AND (members.status = status.FieldID) AND (((((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)) AND ((status.mem_dir = 1))$mem) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)) AND (tbl_area_regional.FieldID = '".$_SESSION['Directory']['disarea']."' $nats))) AND (mem_categories.category != 0) AND (mem_categories.category = categories.catid)) $OrderBy");

     if($_SESSION['User']['Username'] == "stealth") {
      print "SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state,mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,categories,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE (((members.memid = mem_categories.memid) AND (members.status = status.FieldID) AND (((((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)) AND ((status.mem_dir = 1))$mem) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)) AND (tbl_area_regional.FieldID = '".$_SESSION['Directory']['disarea']."' $nats))) AND (mem_categories.category != 0) AND (mem_categories.category = categories.catid)) $OrderBy";
     }
    ...
    if($_SESSION['Directory']['nat']) {
     ...
     $nats = " or mem_categories.dir_nation = 1";
    }
    ...
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state,mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,categories,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE (((members.memid = mem_categories.memid) AND (members.status = status.FieldID) AND (categories.catid IN ($CatComma)) AND (((((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)) AND ((status.mem_dir = 1))$mem) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)))) AND (mem_categories.category = categories.catid) AND (mem_categories.category != 0) AND (tbl_area_states.FieldID IN (".$StateComma.") $nats)) $OrderBy");
    ...
    $CatComma = comma_seperate($_SESSION['Directory']['category']);
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state, mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,categories,members,tbl_area_physical,tbl_area_regional,tbl_area_states,status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE (((((mem_categories.category = categories.catid ) AND (members.status = status.FieldID) AND (categories.catid IN ($CatComma))) AND (members.memid = mem_categories.memid)) AND (((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)$mem) AND ((status.mem_dir = 1))))$mem AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)) $OrderBy");

   } else {

    if($_SESSION['Directory']['PostCodes']) $PostCodeArray = " and (members.postcode IN (".$_SESSION['Directory']['PostCodes']."))";
    $query = dbRead("SELECT categories.category, categories.engcategory, mem_categories.dir_nation, mem_categories.dir_state, tbl_area_states.StateName as State1, tbl_area_regional.RegionalName as disarea, members.fiftyclub, members.companyname, members.contactname, members.streetno, members.streetname, members.suburb, members.city, members.postcode, members.state, mem_categories.description, mem_categories.engdesc, members.phonearea, members.phoneno, members.faxarea, members.faxno, tbl_members_email.email as emailaddress, members.opt, webpageurl, members.memid, members.trade_per as trade_per, members.date_per as date_per FROM mem_categories,members,categories,tbl_area_physical,tbl_area_regional,tbl_area_states, status left outer join tbl_members_email on (members.memid = tbl_members_email.acc_no AND tbl_members_email.type = 1) WHERE ((((members.memid = mem_categories.memid) AND (members.status = status.FieldID) AND (((members.CID = ".$_SESSION['Directory']['countryid'].")$bro$fifty and categories.display_direct = 1 AND (members.t_unlist != 1)) AND ((status.mem_dir = 1))$mem)) AND (mem_categories.category = categories.catid)) AND (mem_categories.category != 0) AND (members.area = tbl_area_physical.FieldID) and (tbl_area_physical.RegionalID = tbl_area_regional.FieldID) and (tbl_area_regional.StateID = tbl_area_states.FieldID)$PostCodeArray) $OrderBy");
