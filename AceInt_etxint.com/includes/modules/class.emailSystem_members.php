...
$EmailQuery = dbRead("select tbl_templates.*, tbl_jobs.* from tbl_jobs, tbl_templates where tbl_jobs.templateID = tbl_templates.FieldID","etxint_email_system");
...
$EmailQuery = dbRead("select tbl_templates.*, tbl_jobs.* from tbl_jobs, tbl_templates where tbl_jobs.templateID = tbl_templates.FieldID and userID IN " . get_areas_allowed($_SESSION['User']['CID']) . "","etxint_email_system");
			...
			<table width="100%">
				...
				<tr>
					...
					<?
						...
						$oFCKeditor->BasePath	= $sBasePath ;
						$oFCKeditor->Height = '700';
						$oFCKeditor->Value		= $editArray['data'] ;
						$oFCKeditor->Create() ;
