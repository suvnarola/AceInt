<?
	...
	class feePayment extends ebancSuite {
		...
		function payFees($memberRow, $feeAmount, $transType, $methodType, $paidTrade = false, $otherMemberRow = false, $transDetails = false, $feesIncurrID = false) {
			...
			if(!$paidTrade) {
				...
				if($transType == 2) {
					...
					if($afee) {
						...
						if($memberRow['letters'] >= 3 || $memberRow['letters'] == 4 || $memberRow['letters'] == 5 || $memberRow['letters'] == 6) {
