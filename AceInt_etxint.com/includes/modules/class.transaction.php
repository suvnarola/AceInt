<?
  ...
  */
  ...
  function AddFees($Who,$Percent,$Choice) {
  ...
  function DOTransfer($clearTrans = false, $ittTransfer = false) {
   ...
   if(!strstr($_SESSION['Country']['trustacc'],$this->To)) {
      ...
      if($this->FromRow['over_payment'] > 0) {
      	...
      	if($this->FromFees > $this->FromRow['over_payment']) {
	      	...
	      	if(mysql_num_rows($checkSQL)) {
				...
				dbWrite("insert into feespaid (memid,paymentdate,amountpaid,deducted_fees,percent,area,type,feesincurrid) values ('" . $this->To . "','" . $this->FromDBDisDate . "','" . $this->FromRow['over_payment'] . "','0','" . $chargePercent . "','" . $this->ToRow['licensee'] . "','5','0')", DB_NAME);
			...
			dbWrite("insert into feespaid (memid,paymentdate,amountpaid,deducted_fees,percent,area,type,feesincurrid) values ('" . $this->To . "','" . $this->FromDBDisDate . "','" . $this->FromFees . "','0','" . $chargePercent . "','" . $this->ToRow['licensee'] . "','5','0')", DB_NAME);
      ...
      if($this->ToRow['over_payment'] > 0) {
      	...
      	if($this->ToFees > $this->ToRow['over_payment']) {
	      	...
	      	if(mysql_num_rows($checkSQL)) {
				...
				dbWrite("insert into feespaid (memid,paymentdate,amountpaid,deducted_fees,percent,area,type,feesincurrid) values ('" . $this->From . "','" . $this->FromDBDisDate . "','" . $this->ToRow['over_payment'] . "','0','" . $chargePercent . "','" . $this->FromRow['licensee'] . "','5','0')", DB_NAME);
			...
			dbWrite("insert into feespaid (memid,paymentdate,amountpaid,deducted_fees,percent,area,type,feesincurrid) values ('" . $this->From . "','" . $this->FromDBDisDate . "','" . $this->ToFees . "','0','" . $chargePercent . "','" . $this->FromRow['licensee'] . "','5','0')", DB_NAME);
    ...
    $trans1 = "insert into transactions (memid,date,to_memid,buy,sell,tradefees,dollarfees,type,details,authno,dis_date,checked,id,userid) values ('".$this->From."','".$this->ToDBDate."','".$this->To."','".$this->Amount."','0','0','".$this->FromFees."','1','".addslashes(encode_text2($this->Details))."','".$this->AuthNo."','".$this->FromDBDisDate."','0','','".$this->Who."')";
    $trans2 = "insert into transactions (memid,date,to_memid,buy,sell,tradefees,dollarfees,type,details,authno,dis_date,checked,id,userid) values ('".$this->To."','".$this->ToDBDate."','".$this->From."','0','".$this->Amount."','0','".$this->ToFees."','2','".addslashes(encode_text2($this->Details))."','".$this->AuthNo."','".$this->ToDBDisDate."','".$this->Checked."','','".$this->Who."')";
