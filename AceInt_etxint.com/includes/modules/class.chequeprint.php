<?
  ...
  */
  ...
  function ChequePrint($Arg1) {
    ...
    pdf_set_parameter($this->PDF, "license", "X600605-009100-45432E-D1E2B4");
    ...
    $this->PDFFont2 = pdf_findfont($this->PDF, "Verdana", "winansi", 0);
    //$this->PDFImage = pdf_open_image_file($this->PDF, "jpeg", "/home/etxint/public_html/home/images/ebanc.jpg");
    $this->PDFImage = pdf_load_image($this->PDF, "jpeg", "/home/etxint/public_html/home/images/ebanc.jpg",'');
  ...
  function GenerateCheques() {
	...
	while($Row = mysql_fetch_assoc($this->Query)) {
		...
		while($Counter < $this->NumberPages) {
			...
			pdf_set_text_pos($this->PDF, get_left_pos($topbox, $this->PDF, $this->ChequePositions['Name1']['Left'], 10, $this->PDFFont), $this->ChequePositions['Name1']['Bottom']);
			pdf_continue_text($this->PDF, $topbox);
			pdf_set_text_pos($this->PDF, get_left_pos($topbox, $this->PDF, $this->ChequePositions['Name2']['Left'], 10, $this->PDFFont), $this->ChequePositions['Name2']['Bottom']);
			pdf_continue_text($this->PDF, $topbox);
			pdf_set_text_pos($this->PDF, get_left_pos($topbox, $this->PDF, $this->ChequePositions['Name3']['Left'], 10, $this->PDFFont), $this->ChequePositions['Name3']['Bottom']);
			pdf_continue_text($this->PDF, $topbox);
			pdf_set_text_pos($this->PDF, get_left_pos($topbox, $this->PDF, $this->ChequePositions['Name4']['Left'], 10, $this->PDFFont), $this->ChequePositions['Name4']['Bottom']);
			pdf_continue_text($this->PDF, $topbox);
			...
			if($this->DisplayClub) {
			 ...
			 if($Row['fiftyclub'] == 1) {
			   //$club = "50% PLUS CLUB";
			   $club = $_SESSION['Country']['fiftyName'];
			 } elseif($Row['fiftyclub'] == 2) {
			   //$club = "GOLD CLUB";
			   $club = $_SESSION['Country']['goldName'];
			 } else {
			   $club = "";
			 }

			 pdf_setfont($this->PDF, $this->PDFFont2, 10);

			 pdf_set_text_pos($this->PDF, get_right_pos($club, $this->PDF, $this->ChequePositions['Club1']['Left'], 10, $this->PDFFont), $this->ChequePositions['Club1']['Bottom']);
			 pdf_continue_text($this->PDF, $club);
			 pdf_set_text_pos($this->PDF, get_right_pos($club, $this->PDF, $this->ChequePositions['Club2']['Left'], 10, $this->PDFFont), $this->ChequePositions['Club2']['Bottom']);
			 pdf_continue_text($this->PDF, $club);
			 pdf_set_text_pos($this->PDF, get_right_pos($club, $this->PDF, $this->ChequePositions['Club3']['Left'], 10, $this->PDFFont), $this->ChequePositions['Club3']['Bottom']);
			 pdf_continue_text($this->PDF, $club);
			 pdf_set_text_pos($this->PDF, get_right_pos($club, $this->PDF, $this->ChequePositions['Club4']['Left'], 10, $this->PDFFont), $this->ChequePositions['Club4']['Bottom']);
			 pdf_continue_text($this->PDF, $club);
			...
			if($this->DisplayLeftChequeNo) {
				...
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['LCheque1']['Left'], 8, $this->PDFFont), $this->ChequePositions['LCheque1']['Bottom']);
			...
			if($this->DisplayRightChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['RCheque1']['Left'], 8, $this->PDFFont), $this->ChequePositions['RCheque1']['Bottom']+$this->RChequeNoOffset);
				pdf_continue_text($this->PDF, $no);
			...
			pdf_set_text_pos($this->PDF, get_left_pos($bottombox . $ExtraNo, $this->PDF, $this->ChequePositions['Account1']['Left'], 12, $this->PDFFont), $this->ChequePositions['Account1']['Bottom']);
			...
			if($this->DisplayLeftChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['LCheque2']['Left'], 8, $this->PDFFont), $this->ChequePositions['LCheque2']['Bottom']);
				pdf_continue_text($this->PDF, $no);
			...
			if($this->DisplayRightChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['RCheque2']['Left'], 8, $this->PDFFont), $this->ChequePositions['RCheque2']['Bottom']+$this->RChequeNoOffset);
				pdf_continue_text($this->PDF, $no);
			...
			pdf_setfont($this->PDF, $this->PDFFont, 12);
			pdf_set_text_pos($this->PDF, get_left_pos($bottombox . $ExtraNo, $this->PDF, $this->ChequePositions['Account2']['Left'], 12, $this->PDFFont), $this->ChequePositions['Account2']['Bottom']);
			pdf_continue_text($this->PDF, $bottombox . $ExtraNo);
			...
			if($this->DisplayLeftChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['LCheque3']['Left'], 8, $this->PDFFont), $this->ChequePositions['LCheque3']['Bottom']);
				pdf_continue_text($this->PDF, $no);
			...
			if($this->DisplayRightChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['RCheque3']['Left'], 8, $this->PDFFont), $this->ChequePositions['RCheque3']['Bottom']+$this->RChequeNoOffset);
				pdf_continue_text($this->PDF, $no);
			...
			pdf_setfont($this->PDF, $this->PDFFont, 12);
			pdf_set_text_pos($this->PDF, get_left_pos($bottombox . $ExtraNo, $this->PDF, $this->ChequePositions['Account3']['Left'], 12, $this->PDFFont), $this->ChequePositions['Account3']['Bottom']);
			pdf_continue_text($this->PDF, $bottombox . $ExtraNo);
			...
			if($this->DisplayLeftChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['LCheque4']['Left'], 8, $this->PDFFont), $this->ChequePositions['LCheque4']['Bottom']);
				pdf_continue_text($this->PDF, $no);
			...
			if($this->DisplayRightChequeNo) {
				...
				pdf_setfont($this->PDF, $this->PDFFont, 8);
				$no = str_pad($this->ChequeNo, 6, "0", STR_PAD_LEFT);
				pdf_set_text_pos($this->PDF, get_right_pos($no, $this->PDF, $this->ChequePositions['RCheque4']['Left'], 8, $this->PDFFont), $this->ChequePositions['RCheque4']['Bottom']+$this->RChequeNoOffset);
				pdf_continue_text($this->PDF, $no);
			...
			pdf_setfont($this->PDF, $this->PDFFont, 12);
			pdf_set_text_pos($this->PDF, get_left_pos($bottombox . $ExtraNo, $this->PDF, $this->ChequePositions['Account4']['Left'], 12, $this->PDFFont), $this->ChequePositions['Account4']['Bottom']);
			pdf_continue_text($this->PDF, $bottombox . $ExtraNo);
