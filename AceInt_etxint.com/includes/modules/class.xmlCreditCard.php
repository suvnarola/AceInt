...
//error_reporting(5);     //  AWS Mod   Tutning off.
...
/*  AWS  updated urls
Test URL: 
https://test.api.securepay.com.au/xmlapi/payment
...
//  AWS Hack to force Test Server.
//$test = true;

		if($test) {

			//$this->serverHost = "www.securepay.com.au";
			$this->serverHost = "test.api.securepay.com.au";
			//$this->serverHost = "ssl://www.securepay.com.au";
			$this->serverHost = "ssl://test.api.securepay.com.au";
		...
		// LIVE TRANSACTION
			...
			//$this->serverHost = "www.securepay.com.au";
			$this->serverHost = "api.securepay.com.au";
			//$this->serverConnectHost = "ssl://www.securepay.com.au";
			$this->serverConnectHost = "ssl://api.securepay.com.au";
			$this->serverPath = "/xmlapi/payment";
			$this->serverPort = "443";
			$this->test = 0;
	...
	function auth($merchantID,$password) {
		...
		//  AWS Mod to set Credentials
		$this->merchantID = "4CL0031";
		//$this->password = "P8Nqdeh7";    // Test Server
		$this->password = "dm1ErArH";    // Live Server
		return;
	...
	function http() {
		...
		$socket = @fsockopen($this->serverConnectHost, $this->serverPort, $errno, $errstr, $this->serverTimeout) or $this->error_display(510,"Unable to connect to $this->serverHost on port $this->serverPort");
		...
		while(!feof($socket)) {
			...
			//print $line;     //  AWS Mod stop printing raw message to screen.
			// HANDLE STATUS CODES
