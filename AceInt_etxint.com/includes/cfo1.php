...
<form method="post" action="/general.php" name="cfo">
...
<?
	...
	if($_REQUEST['error']) {
		...
		?>
			...
			<table width="620" border="1" bordercolor="#FF0000" cellpadding="10" cellspacing="0">
				<tr>
					<td bgcolor="#FFFFFF"><b>[1]: <?= $_REQUEST['errorMsg'] ?> $<?= $_REQUEST['errorAmount'] ?></b></td>
				</tr>
			</table>
			<br>
...
?>
  <tr>
    <td colspan="5" align="right"> <input type="checkbox" name="fees" value="2"> Reversal of Admin Fees | <input type="checkbox" name="fees" value="1"> <?= get_page_data("2") ?> | <input type="submit" value="<?= get_word("83") ?>" name="feereverse"></td>
  </tr>
...
<form method="POST" action="body.php?page=cfo1" name="cfo">
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	...
	<tr>
		<td width="100" align="right" class="Heading2"><b><?= get_word("1") ?>:</b></td>
