...
?>
  ...
  <tr> 
      ...
      <td width="450" height="30" colspan="4" bgcolor="#FFFFFF">
		<input type="Submit" value="<?= get_word("48") ?>" ?>">&nbsp;<input type="Submit" name="emsa" value="<?= get_page_data("5") ?>" ?>">&nbsp;<input type="Submit" name="vssa" value="<?= get_page_data("6") ?>" ?>">&nbsp;<? if(checkmodule("PrintCheque")) { ?><input type="Submit" name="pcheque" value="<?= get_page_data("7") ?>" ?>"><? } ?></td>
  </tr>
</table>
</td>
</tr>
...
?>
		<tr id="<?= $row['memid'] ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');">
			...
			<td width="13" align="right"><a href="javascript:notes('body.php?page=notes&memid=<?= $row['memid'] ?>')">
			<img src="images/icon_n.gif" border="0" width="16" height="15"></a></td>
			...
			<a href="body.php?page=member_edit&Client=<?= $row['memid'] ?>&pageno=1&tab=tab7&currentmonth=<?= date("n") ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1" ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1" ?>&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1&numbermonths=1&currentyear=<?= date("Y") ?>&DisplayStatement=1"><img src="images/icon_s.gif" border="0" width="16" height="15"></a></td>
			<td width="13" align="left" valign="middle"><b><?= $let ?><?= $let2 ?></b></td>
		</tr>
		<?if($_REQUEST['catid']) {?>
		 <?if($_SESSION['User']['emcus'] == 1) { ?>
		 <tr id="<?= $row['memid'] . "85478" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" ?>" bgcolor="<?= $bgcolor ?>" onmouseover="setPointer(this, <?= $row['memid'] . "85478" ?>, 'over', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmouseout="setPointer(this, <?= $row['memid'] . "85478" ?>, 'out', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');" onmousedown="setPointer(this, <?= $row['memid'] . "85478" ?>, 'click', '<?= $bgcolor ?>', '#BBBBBB', '#AAAAAA');">
...
?>
  ...
  <tr> 
      <td width="100" height="30" class="Heading2"></td>
      <td width="450" height="30" colspan="3" bgcolor="#FFFFFF">
		<input type="Submit" value="<?= get_word("48") ?>" ?>" ?>" ?>" ?>" ?>" ?>">&nbsp;<input type="Submit" name="emsa" value="<?= get_page_data("5") ?>" ?>" ?>" ?>" ?>" ?>" ?>">&nbsp;<input type="Submit" name="vssa" value="<?= get_page_data("6") ?>" ?>" ?>" ?>" ?>" ?>" ?>">&nbsp;<? if(checkmodule("PrintCheque")) { ?><input type="Submit" name="pcheque" value="<?= get_page_data("7") ?>" ?>" ?>" ?>" ?>" ?>" ?>"><? } ?></td>
  </tr>
